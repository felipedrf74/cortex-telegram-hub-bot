...
export const approvedDirectMigrationReplays = new Map([
  ...
  ['__tests__/scripts/production-shape-migration-rehearsal.test.ts', { expectedCalls: 5, reason: 'Five governed predecessor/candidate production-shape rehearsal scenarios with private clone cleanup and fail-closed evidence checks.' }],
