...
prepare_landing_bundle() {
  ...
  require_grep '\$14\.99/month or R\$74,99/month' "$LANDING_DIR/llms.txt" 'llms.txt must show current Pro prices'
  require_grep '\$19\.99/month or R\$99,99/month' "$LANDING_DIR/llms.txt" 'llms.txt must show current Max prices'
