...
prepare_landing_bundle() {
  ...
  require_grep '\$9\.99/month \(USD\)' "$LANDING_DIR/llms.txt" 'llms.txt must show current Pro prices'
  require_grep '\$14\.99/month \(USD\)' "$LANDING_DIR/llms.txt" 'llms.txt must show current Max prices'
