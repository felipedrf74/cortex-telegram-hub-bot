...
IOS_ROOT="${IOS_ROOT:-/Users/felipedominguez/Desktop/Nexus Hub IOS/Nexus Hub}"
...
export TELEGRAM_BOT_TOKEN="${TELEGRAM_BOT_TOKEN:-local-disabled-decision-center-ios-smoke}"
export TELEGRAM_ALLOWED_USER_IDS="${TELEGRAM_ALLOWED_USER_IDS:-100000001}"
export OWNER_TELEGRAM_ID="${OWNER_TELEGRAM_ID:-100000001}"
export TELEGRAM_LEGACY_DELIVERY="false"
