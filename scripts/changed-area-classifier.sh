...
if $HAS_NON_DOC; then
  if $HAS_TEST_CONFIG || $HAS_PACKAGE_JSON; then
    ...
    $HAS_NOTIFICATION && VITEST_GLOBS+=("__tests__/services/apns-*.test.ts" "__tests__/services/notification-*.test.ts" "__tests__/services/decision-center.test.ts" "__tests__/services/decision-center-logic-v2.test.ts" "__tests__/services/content-notifications*.test.ts" "__tests__/api/notifications-*.test.ts" "__tests__/api/decisions-routes.test.ts" "__tests__/api/content-notification-*.test.ts" "__tests__/security/notification-*.test.ts" "__tests__/security/p0-chat-identity-isolation.test.ts")
