 ...
 *
 * This validates only local coordination invariants: the active Work Order
 * exists, declares ownership, and matches the current branch and worktree; the
 * optional registry exists and has well-formed active rows. It is read-only and
 * never inspects secrets or runtime data.
 */
