...
- **training**: Preserve non-m4 continuous plans ([`6a2811b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6a2811bcb65184ee2939f6db9de97cfb166c3433))
- **training**: Support deployed media database path ([`166e58f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/166e58fecd554c1442a635cefeea6cb503834f31))
- **release**: Use production fuser syntax ([`148758f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/148758fde013be16150042a90bfab239ae9b44fe))
- **release**: Harden production backup recovery ([`9a3d774`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/9a3d774812ef71a6255980b83bd76a0555490fb7))
- **staging**: Align backend memory ceiling ([`28cfc51`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/28cfc516db8a0b3c4211b5197e9158676b3a19df))
- **release**: Validate effective domain encryption keys [skip ci] ([`b6b5ff1`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b6b5ff188b83dc453006d604ce7293fea265b633))
- **ci**: Shard full Vitest gate ([`db11f21`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/db11f214d9f8e75b3dd088f9f8b203d34f8baae4))
- **security**: Rate-limit health latest route ([`ceea156`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ceea1566c6264676f302319cd4270b3f0eb143cc))
- **security**: Harden credential rotation and release bootstrap ([`e3aaf89`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e3aaf896d0dbacea92b22b7991e58ab0dec53b8d))
- **health**: Use authoritative sync timestamps ([`282079f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/282079feea8122062a6d05483688bbcbd572c954))
- **security**: Add fail-closed data encryption key rotation ([`353df9d`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/353df9d62a69ad7c0ecbb45dbd782e6245ee2a05))
- **training**: Enforce external media publication gate ([`fb9eef6`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/fb9eef6ee6d0f9e997b7f245b6ce5b09b20dc220))
- **training**: Harden M4 adaptation and schedule gates ([`6fb21a2`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6fb21a2470e2c0a07d0f7c334f267c72e598c783))
- **training**: Close M4 generation and conflict gaps ([`343df7a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/343df7a0a3c6a3ac42d25cd27adbaf10095c0aaf))
- **security**: Remove APNs key metadata from errors ([`84a5a93`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/84a5a9349d244165d1dc1bbe6594b590aa7c3e51))
- **security**: Redact invalid APNs key diagnostics ([`1e5abf7`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/1e5abf7c6e34c7144a7014d0f8fb01c6e3b5811a))
- **training**: Harden draft media review gate ([`6940f02`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6940f02656bae446cb1191a41593c2fb54af19e8))
- **training**: Package revision backfill operator ([`87dd89f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/87dd89fc6f6772b8bfe24abb67815812f606d60b))
- **training**: Fail closed on mixed revision rollout ([`eac088f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/eac088f859f72050c5976c754caee2c743de02e0))
- **security**: Pin patched transitive dependencies ([`08b9849`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/08b984927435944b1969b5b353914dbffa259fbf))
- **decisions**: Remediate decision flow v1 QA findings ([`85abd64`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/85abd6409cc3fe00fc4a026db1fb8b26b4935d69))
- **ai**: Harden paid cost controls ([`fa4de82`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/fa4de82e900469e1bb1db4152fe7b7707d2b4f32))
- **coach**: Gate briefings and compact reports ([`9c68db5`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/9c68db5a3d6ec65b881e13400ca9fd55fcb7b76f))
- **secretary**: Repair missing fresh provider events ([`0f53209`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/0f532094cbecd97dc1ef42a474b996ec96aaa627))
- **secretary**: Reconcile duplicate events on fresh sync ([`e700826`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e700826f7b5fdf73c12134b81ab1a81479181350))
- **training**: Align split titles with assigned structure ([`81b90b8`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/81b90b878ae230d86696c033c5c1c235d44c6db5))
- **secretary**: Preserve training calendar ownership ([`32114d7`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/32114d727d1109ff63eebadbe1f80c2625a1bd98))
- **release**: Make staging smoke PM2 gates real checks ([`113b83a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/113b83a510de613bc192acddf47499307a9266b6))
- **training**: Harden calendar sync lifecycle ([`b28a47b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b28a47b6d459dfd36f745c2e21e7b452685a8034))
- **training**: Expose requested targets and dead-letter state, restore learning-path persistence ([`ae75d17`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ae75d178abbe9dce95ca3970e927da48fb981d57))

### Chores

- Prepare release 4.14.217 ([`e3f0071`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e3f00711fb520d0b19a7a674a7903a4b98708447))
- **training**: Refresh draft media authority pin ([`c47a277`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/c47a2771892cde98e6767d748a90b8c85edf4fa6))
- **training**: Prepare draft media review bundle ([`9a4c0cd`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/9a4c0cde5bfb93733c6f706fbc590f7b020af695))
- Prepare release 4.14.216 ([`6c67c18`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6c67c181ed1b9cad4a82a03affedec778531f469))
- Prepare release 4.14.215 ([`f873737`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/f873737773a15cbccd94ecd479f9e5256d71ac6e))
- **release**: Mint 4.14.214 + promote version policy ([`dd7afaf`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/dd7afaf83677cdd797707a5d3a0728ae0a2a87f6))

### Documentation

- **release**: Distinguish runtime from docs head ([`cb3313c`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/cb3313c9423258ed2d5e2fe6062dcd821cddc74e))
- **release**: Record Training public beta promote ([`03c1958`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/03c1958bc86b7a8d600fd5c204942738d7bb53cd))
- **training**: Record public beta release candidate ([`e4ba5be`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e4ba5bef1e7a4f67363c7729d933d79c946af9a2))
- **release**: Clarify Training artifact source ([`d110f1b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/d110f1b1d82ea00fd3b450f5be1abe91c2cc0fdf))
- **release**: Record Training staging gate ([`10586cb`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/10586cb2ceb9b5e062fcde77345521d881771c55))
- **release**: Mark training media source dormant ([`15e009d`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/15e009dff47610ab3a9b93c5c80cbfe835b7ec89))
- **training**: Close production implementation checkpoint ([`7a0e1a8`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7a0e1a843a53fd76a66b4abfceb5006d74e3609e))
- **training**: Define optional integration boundaries ([`8d58487`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/8d5848710d8c1a9fa349294ce86ff414e2da74c5))
- **decisions**: Record Decision Flow v1 QA remediation ([`0df698e`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/0df698e67aa17264baa371f27dffa1b9b66fc00f))
- **release**: Sync paid AI release identity ([`7d039ea`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7d039eaae6187928f7fe7c3dfaea3c5432878059))
- **release**: Record paid AI production promote ([`ccc2001`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ccc2001d8a5f2e24ff3c2e2e714d9175fbc70a20))
- **release**: Sync paid AI open items ([`3cf19dc`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/3cf19dce0c0bb7507765893f6d218a8dd1bcc4f1))
- **ai**: Record cost control fix verification ([`8283594`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/82835940b7df204eaa6351b2785969dd8c5cf2c2))
- **release**: Record paid coach briefing deploy ([`bbd8205`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bbd8205be63008937bb65180c06b1fd6f3986d54))
- **release**: Close training calendar promote ([`bbf0e50`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bbf0e50ab6c43c10fd597cb28972a6f8b4567e53))
- **release**: Record 4.14.215 staging smoke ([`cdfe938`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/cdfe9388c59c63eac5433964098a9d1fe6f859c5))
- **release**: Refresh workspace release identity ([`abc4570`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/abc45703e864361e04944949803cbf44af5d45bc))
- **release**: Close 4.14.214 p3 tooling promote ([`bb9b445`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bb9b445cb0845c9eb3a7a7179f8f3fc5f6669fc6))
- **release**: Record 4.14.214 staging smoke ([`df21fd0`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/df21fd040227fd37663893881a992cd2780fa1ac))
- **agents**: Update training reward closeout ([`e281a44`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e281a44f6d1e3617b66b2facb009868b8bf4b395))
- **release**: Close training qa promote ([`21ebad3`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/21ebad3e7eeec4076fe6a57073de52e4ed292e59))
- **release**: Record training qa staging smoke ([`b1916a7`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b1916a7679c96a1f87b4e800b0e5c6b087978979))
- **agents**: Capture training qa handoff ([`90d0a8a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/90d0a8a3b6dbb07b14b0a01ec730fba4559d32b1))
- **release**: Record 4.14.213 production promote (7511266b) ([`ca901c4`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ca901c4acc8c5af6b11b0494d6b27105b2b008cd))
- **release**: Persist staging smoke evidence for a33b349d (19/19, v4.14.213) ([`7511266`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7511266b24a74fb06bf7a069551b4909de146bd3))
- **release**: Record 4.14.212 production promote (0df62678) ([`a061efb`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/a061efbde00316d8e6a95156e29b43d54062296d))
- **release**: Persist staging smoke evidence for 200e8a12 (24/24, v4.14.212) ([`0df6267`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/0df6267878e7da58aac41e3240153b9027dfe286))
- **release**: Apply open-items reaudit — 5 rows refreshed, 10 added, drift fixed ([`6c7bf23`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6c7bf23e9f22c74dd8a930496b7d7c8666f514c1))
- **release**: Record Training UX round production promote (6bb2affe) ([`2330f2b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/2330f2b367c2968bcc271a0770e89072ad590134))
- **release**: Staging smoke evidence 19/19 for cfb5f33f pre-promote ([`6bb2aff`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6bb2affedb6fce80eb697ee3ffb1c0590ea4c7dd))
- **release**: Record 4.14.211 promote and Training UX round evidence ([`cfb5f33`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/cfb5f33fcd5924ca4faa93a3d3a456a1f5cdd462))

### Features

- **training**: Ship authoritative public beta ([`fff8cd8`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/fff8cd8e43e41abe4b738de7df83d466b3334f41))
- **training**: Publish approved exercise media catalog ([`635f75e`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/635f75edfd166475f2be580465531660af275478))
- **training**: Add milestone 4 planning foundation ([`34bfeb9`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/34bfeb939df0acdac88f344db6a776b68bc00746))
- **training**: Add scoped adaptation proposals ([`65cc918`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/65cc91850f8b9f147a90833382a95e66ff2abd57))
- **training**: Complete phase-aware typed plans ([`cbbf626`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/cbbf6268344496915dadcf78f67e195faf42284d))
- **training**: Add typed workout validation foundation ([`db10a0d`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/db10a0de506b8cc371d02505da49269a0d7dfb0b))
- **training**: Bind media approvals to immutable evidence ([`2d438c6`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/2d438c6d8cb589d274a6dd0315d409492b09ebd4))
- **training**: Add governed exercise media platform ([`ccff8af`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ccff8afe8fc21fdea9beb5b2b4a8a6874c450823))
- **training**: Add typed workout validation foundation ([`ac8dd85`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ac8dd855892dd9044a541a00ad7073e26b04e07f))
- **training**: Close exercise identity boundaries ([`3c8aa4a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/3c8aa4a23c86fc6a6cf3930b93fd1efd4366d3f5))
- **training**: Add Milestone 1 plan revision slice ([`b0f893f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b0f893fcaa950c4a081ab7541794b5a8fedb2bb4))
- **ai**: Add paid-only cost controls ([`3ce2047`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/3ce204737f4f6c1caf60c29bfc7aa5f172ac1c68))
- **notifications**: APNs reliability + engagement round (v4.14.213) ([`a33b349`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/a33b349d7e9fe024b9325f913fb82f1b92c554dd))

### Performance

- **core**: Token/notification optimization round + per-user report schedules (v4.14.212) ([`200e8a1`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/200e8a1212f976da77dcef39be811124cddf54b6))

### Tests

- **ci**: Complete async database mock surface ([`e91b334`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e91b334df3eb612899a752754ae956cdd711f028))
- **training**: Isolate plan matrix scenarios ([`b4e7032`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b4e7032ce0108d7e3055c6f9fec89cb9540ce27a))
- **ci**: Close database mock completeness debt ([`987eb1a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/987eb1abddb662b5a0d005619fed18ca1bfc1dd4))
- **ci**: Eliminate decision flow partial mock debt ([`47d9049`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/47d90498674bafd6bb622c31f01c81957f915131))

## [4.14.211] — 2026-07-02

### Bug Fixes

- **training**: Remediation round — targets honesty, taper cutoff, sync dead-letter ([`3f66029`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/3f66029627103facc5423d39df54b333f386bc68))
- **release**: Risk-gate base fallback for explicit-files mode ([`5e2c0d1`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/5e2c0d1c59689b69e9af3178fcfb7c6f82fd8515))
- **training**: Tighten agenda provider and split repairs ([`b84b994`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b84b9940f1f374ef6a6228818c76de388a38a7ca))
- **training**: Close post-merge minor follow-ups ([`12ae844`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/12ae8445f9967683d41117cccc0443971db5b8b5))
- **security**: Close validation gap siblings ([`1f4bb0b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/1f4bb0b0414d55dcbb7d89f236cbf14e03af438e))
- **training**: Stabilize plan creation targets ([`f50009f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/f50009fbcd349df3d95228ecfe107b3cb56177ab))
- **tasks**: Clear provider-missing after provider reappears ([`b8bd0c2`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b8bd0c2975228fcce6af30b1e0c4a9d216d67cad))
- **training**: Repair scheduled deload focus before linting ([`a4445f9`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/a4445f981e93922756cc4b27ad71d70161210df2))
- **tasks**: Keep completed provider tasks out of active reads ([`20432fb`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/20432fb75d65e24db31fe96cb17d9d1bc5811527))
- **tasks**: Start provider sync after oauth connect ([`22e933e`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/22e933e39866b7af1a762808f224b7b72a6408fd))
- **tasks**: Bound microsoft todo sync calls ([`7deed73`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7deed73cdfcc27a1e12a4b6bd92e3b4379211893))
- **tasks**: Sync microsoft todo into offline store ([`b0a0594`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b0a0594a443c894bca7c77d500a8de0216a830f5))
- **tasks**: Bridge legacy native tasks into offline store ([`bd0e009`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bd0e0096c7ba2865c36464d907ddf226bcbdcad8))
- **dashboard**: Ignore all-day calendar markers in day dial ([`52e1f52`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/52e1f52c42fabf861d6288a36ac1893be096dc42))
- **training**: Align beginner deload policy ([`bc1de70`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bc1de70e3166679c1f2f9894aaebe0f67e476e5f))
- **training**: Avoid implicit runs for strength plans ([`61617b8`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/61617b8ffdb11715afec0bd7805c697d508755f5))
- **training**: Close red flag signal QA gaps ([`476a299`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/476a299f02798060a4145c9aeea19d6ddfb42ef4))
- **training**: Harden release blockers ([`5206ffd`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/5206ffd2b3d991b2ebfa291ef3966445bd282333))
- **training**: Avoid empty week one for Sunday starts ([`a226980`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/a226980523b46c047998838c071450b73ad920b0))
- **training**: Harden calendar sync QA flow ([`ccd8815`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/ccd8815f1064e52472decb6641dca713ab7a67d6))
- **onboarding**: Treat bare sport profile_type keys as aliases of the canonical triathlon-* ids ([`58e5b66`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/58e5b668c1e19f923cb8ebdf86e7a1c0a2f67cf5))
- **training**: Derive energy_level from fatigueLevel on session completion ([`aeac2cd`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/aeac2cd9c0dd956e3a555c4dd3e01541dbfe145e))
- **training**: Persist iOS completion duration/wellbeing and surface them in progression ([`9ce79ca`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/9ce79caa1fa9ae415e7c1e53b114767c031931fc))
- **training**: Clamp event-based plan duration to race date ([`0152e14`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/0152e14207fc3d3a9cf84e8e2adf4f73c37d57fd))
- **training**: Clear tenant-first training-home cache family on training writes ([`255eaf5`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/255eaf52eaa54dd2d108b89837b7bd65234a0b92))
- **training**: Fitness gate returns requiredQuestionnaireId/Title for routing CTA ([`31a9d1f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/31a9d1f294b7dd2130640fc4bd0d76188380fb9d))
- **training**: Provider-aware energy vocabulary in home view-state ([`afd490b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/afd490b4576469b4ee7a73e2807b588d5356b76c))
- **training**: Overlap vocabulary in home view-state + un-freeze Friday-bound chat test ([`626ce63`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/626ce632f88cc6ba85bd880a5cb74fd3f37aae82))
- **training**: Address phase-0 review findings ([`1f98a0f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/1f98a0f7a5fa9003a4eef40482b7151dc7654189))
- **training**: Tenant-scope the load-model hydration query ([`2744e16`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/2744e161b253eb812631a9b612313504f714798f))
- Open public registration for release ([`30924df`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/30924df25c5d22d18dc5507e050bdacc554936e3))
- Stabilize overdue tasks and wearable sleep ([`31c16dc`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/31c16dcbbf7abaf841047a8fffa3abead401986a))
- **decision-center**: Harden notification release paths ([`0f1244d`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/0f1244d7cd7a2b646617071f268d91413ae8b75b))
- **home**: Restore sleep intervals in day dial ([`b2693f0`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/b2693f02131ca3703f700af47a24a9deac9e4b89))
- **training**: Scope analytics reads by tenant ([`bc209dd`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/bc209dd31313d836303a29cfe229a0a34501a645))
...
- Prepare release 4.14.211 ([`f0c3fc3`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/f0c3fc3e5d3d8f8ac4914d9adad55188417b5182))
- Prepare release 4.14.210 ([`c99ac80`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/c99ac80cd5b260f94e0b1c100512cc06547ed376))
- Prepare release 4.14.209 ([`762aa3c`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/762aa3cff3d70d32dec38a9549a1054727e2d75d))
- Restore notification cache license header ([`7d52933`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7d529331b0e3c382d62aca2e7dac762bc420b6b9))
...
- **release**: Record tasks provider-missing hotfix ([`2617dfd`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/2617dfd784abbe928572efa1da0d85759ecda83c))
- **training**: Hand off deload plan hotfix ([`f7e012e`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/f7e012e8e7d12451b85ce5a5bda4ce3e8191eeb2))
- **release**: Clarify post-promote identity closeout ([`97c3aa3`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/97c3aa3528f034bd8503355c7681fa28ce81099c))
- **release**: Record content studio production promote ([`dc1cfb0`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/dc1cfb082359c7a4702dfc1e259e6894588581b7))
- **release**: Add content studio final staging smoke evidence ([`636910e`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/636910e20a18643827b7e421e7f155369c309293))
- **release**: Add content studio staging smoke evidence ([`c3be2ca`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/c3be2cad130164c53145882e2231cc74db73a6c4))
- **release**: Record training hotfix production closeout ([`a510a5b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/a510a5b80ab30c0858147b8aea4ddd0617f3a343))
...
- **training**: Ship skill e2e hardening ([`4a75448`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/4a75448e5c7e5b0bbfbcce66d3290868c9ec0418))
- **training**: Add plan creation validation matrix ([`6bf2ead`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6bf2ead06c50a3af8d0623b7aeb451957d11bf47))
- **tasks**: Add offline-first task sync architecture ([`087084f`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/087084f0a589757954414e6e96b959ad3cfb25a6))
- **decision-center**: Surface daily task attention ([`7e2255b`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/7e2255bec5e5492a2fa04e224ad7b4dddf23551b))
- **training**: Harden plan creation release path ([`2045797`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/20457975da1f6994fea7ffc4b073eca76d126251))
- **training**: Add GET /training/load-snapshot with shared load-model hydration ([`cd621f1`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/cd621f1ebf89d4b4a2f367b3b093eb056e3ae2e2))
- **training**: Add keyset-paginated GET /api/v1/training/history endpoint ([`2511899`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/2511899b2e9272e383d71bf804d9d8c5465cbcfb))
- **training**: Expose raceDate and goalMode on /plan/weeks read model ([`e4c6633`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e4c66336e3e15f6a90a6fb224c2db8f6ff88875e))
- **training**: Add keep-original adaptation opt-out route and read-path gates ([`e14bbdc`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/e14bbdcd83c216dbe443daf037ff4891be5bd26b))
- **training**: Add readiness provenance source and asOf fields ([`beafc7a`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/beafc7a5b0fcacba39d5bd2a04fb29c89b0de31c))
- **content**: Studio backend contract — skill-scoped overview, capture provenance, idempotent topic create ([`6651085`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/6651085ea1d1ded761a0a88d4795888ba2ecd58f))
...
- **training**: Cover post-merge minor edge cases ([`39f6d54`](https://github.com/felipedrf74/cortex-telegram-hub-bot/commit/39f6d544f13b86c423241bd615f49447914397ea))
