...
- Secretary, Training, Cooking, and Content write-like actions start as preview-only; Secretary schedule event, Cooking grocery item, and Content brief draft previews are the first wired slices in that lane.
