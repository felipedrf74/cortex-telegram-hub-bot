...
- Runtime commit: `2b14b82c4a537904774d3d31aa441a7eeae11861`
- Artifact digest: `49003001ea49f65806de9823235f8ef56a9a0451f4124b81f600f60719b83564`
...
- Production transaction `20260801T224831Z-11efa65022e2` completed at `2026-08-01T22:49:45.670Z`.
...
- The transaction took 73.700 seconds: 11.964 seconds to readiness and a
  measured 61.735-second soak.
- Rollback was armed but not required; backup: `nexus-db-20260801T224838Z.sqlite.age`.

## Artifact-Bound Evidence

- Protected-main run: `30710186698`
- Release-checkpoint run: `30710263802`
- Compact manifest SHA-256: `9829918457793e9e3f0fe85fd88ca27ee81923f813404451349165c51f5ec445`
- Staging transaction: `20260801T223342Z-350d8412d295`
- Production transaction: `20260801T224831Z-11efa65022e2`
- Encrypted backup SHA-256: `b8ae7e1ea55b3370b9e7979d4d9920a689d36149150c70edba66f60e41f1e0fb`
...
- Current sample: main 1m48s (pass), unattended handoff 19s (pass), checkpoint
  5m33s (pass), and automated readiness 7m40s.
- Selected/remainder/union was `573/15,850/16,423` tests across
  `35/1,075/1,110` files; partitions were disjoint and complete.
- Five of ten releases are measured. Nearest-rank provisional p50/p95 values
  are 7m01s/16m32s for main, 29s/8m13s for unattended handoff,
  4m21s/5m33s for the checkpoint, and 14m10s/19m01s for automated readiness; the sample is not yet stable.
...
- Against the 19m40s readiness baseline, provisional median improvement is
  5m30s (27.97%). Promotion passed for all five observed releases; review for
...
- Staging's lean predecessor layout was restored from the verified `77f92f6d`
  bundle before the exact `2b14b82c` staging and production transactions passed.
