...
| Calendar/agenda | Lifecycle tests, no-duplicate/idempotency tests, cancellation cleanup tests | Google/Outlook staging provider smoke | Provider smoke and cleanup evidence | No calendar/provider/agenda/migration changes since last smoke | Provider mapping, cancellation, sync, reminders, Secretary arbitration changed |
