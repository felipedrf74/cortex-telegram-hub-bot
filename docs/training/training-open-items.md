...
| --- | --- | --- | --- |
| TR-P2-DEVICE | iOS | Physical-device Training interaction and account-switch stale-cache test not run. | Run signed device/TestFlight Training smoke on an available iPhone. |
