...
| GAP-CONT-1 | P0/P1 | content runtime | 2026-05-12 | Portal channel writes now reject client-supplied owned-channel markers unless ownership is server-verified, and YouTube creator analytics scope resolution ignores unverified manual metadata. Backend live performance aggregation is now wired under GAP-CONT-3; iOS performance dashboard truth remains tracked by GAP-CONT-4. |
