...
approval and a documented replacement. Agents must consult
`docs/agent/OPERATING_CONTEXT.md` §"Session End — Definition of Done"
before ending any session that ships code, deploys to production, or
introduces a new canonical doc.
...
| Worktree recovery audit 2026-05-18 | historical | `docs/release/worktree-recovery-audit-2026-05-18.md` | One-off archive-first audit of backend/iOS worktrees, preservation artifacts, cleanup disposition, and promotion queue. |
