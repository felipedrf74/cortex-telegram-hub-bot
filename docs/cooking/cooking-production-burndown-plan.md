...
1. Add iOS correction capture, pantry freshness rendering, and rich Cooking simulator smoke. Assessment warning/context/preference rendering is implemented on `feature/cooking-rich-state-ui` at `f4f1053`.
