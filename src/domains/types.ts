...
import type { CapabilityDomainName } from '../generated/capability-skill-metadata';

/** The built-in domains generated from CapabilityManifest. */
export type DefaultDomainName = CapabilityDomainName;
