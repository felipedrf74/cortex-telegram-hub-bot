...
// ── Calendar lookup request-coalescing cache ──────────────────────────
//
...
type CalendarLookup = Map<string, { time: string | null; event: any }>;
const calendarLookupInflight = new Map<string, Promise<CalendarLookup>>();
const calendarLookupRecent = new Map<string, { value: CalendarLookup; expiresAt: number }>();
