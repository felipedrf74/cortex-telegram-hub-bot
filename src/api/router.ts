...
export function createApiRouter(): Router {
  ...
  router.get('/', (_req, res) => {
    res.json({
      ...
      endpoints: {
        ...
        cooking: 'GET/POST/PATCH/DELETE /api/v1/cooking/{recipes|meal-plan|shopping-list|pantry|preferences} — tenant-scoped deterministic Cooking state',
        ...
        plan: 'GET /api/v1/plan/{week|today}, POST /api/v1/plan/recompute — unconditional tenant-scoped multiskill mesh',
  ...
  router.use('/admin/ai-credit-grants', aiCreditGrantsAdminRoutes());
