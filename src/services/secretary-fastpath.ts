...
const COPY: Partial<Record<Lang, Copy>> = {
  'pt-BR': {
    ...
    taskCreateNoList: '⚠️ Lista padrão do Microsoft To Do não encontrada. Configure em Ajustes > Conexões.',
  ...
  'en-US': {
    ...
    taskCreateNoList: '⚠️ Microsoft To Do default list not found. Configure in Settings > Connections.',
  ...
  'pt-PT': {
    ...
    taskCreateErrorDetail: '⚠️ Erro ao criar tarefa:',
    taskCreateNoList: '⚠️ Lista padrão do Microsoft To Do não encontrada. Configura em Definições > Ligações.',
