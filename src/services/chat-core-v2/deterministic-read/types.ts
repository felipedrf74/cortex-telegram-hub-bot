...
import type { ChatCoreV2AllowedSurface } from '../activation-flags';
...
export interface ChatCoreV2DeterministicReadRouteResult {
  ...
  capabilityIds?: ChatCoreV2DeterministicReadCapabilityId[];
  routeGuess: ChatCoreV2ShadowRouteGuess;
  readModel: ChatCoreV2ReadModelResult<ChatCoreV2DeterministicReadData>;
  readModels?: ChatCoreV2ReadModelResult<ChatCoreV2DeterministicReadData>[];
