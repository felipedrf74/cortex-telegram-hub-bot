...
export const CONTENT_ACTIONS: ChatActionDefinition[] = [
    ...
    },
  {
      ...
      readableIntents: ['content work block', 'schedule filming', 'agenda a gravação', 'schedule an editing session'],
      ...
      examples: [
        ...
        {
          text: 'Schedule a writing session for the reel on Friday morning',
          locale: 'en',
          tags: ['golden'],
          expectedAction: 'content_schedule_work',
        },
        {
          text: 'Agenda a gravação do reel sobre rotina matinal para sexta às 10h',
          locale: 'pt',
          tags: ['golden'],
          expectedAction: 'content_schedule_work',
        },
    ...
    },
  {
      ...
      readableIntents: ['publish content externally', 'schedule a publication', 'track content as published'],
      requiredFields: ['publicationRequest'],
      optionalFields: ['requestedMode', 'platform', 'scheduledFor'],
      providerDependencies: ['none'],
      risk: 'ambiguous',
      confirmationPolicy: 'none',
      executionPolicy: 'blocked',
      executor: 'content.publishUnsupported',
      verifier: 'none',
      typedSlotExtractors: [contentPublicationRequestSlotExtractor],
      typedSlotValidators: [makeRequiredFieldsValidator(['publicationRequest'])],
      supportedCards: STATUS_CARDS,
      examples: [
        {
          text: 'Publish this reel now',
          locale: 'en',
          tags: ['golden'],
          expectedAction: 'content_publish_now',
        },
        {
          text: 'Publica este reel agora',
          locale: 'pt',
          tags: ['golden'],
          expectedAction: 'content_publish_now',
        },
