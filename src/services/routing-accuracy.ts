...
import {
  ROUTING_ACCURACY_SNAPSHOT_MINIMUM_LABELED_ITEMS,
  ROUTING_ACCURACY_SURFACES,
  ROUTING_ACCURACY_VERSION,
  parseAcceptedRoutingAccuracySnapshot,
  type RoutingAccuracyReport,
  type RoutingAccuracySurface,
  type RoutingCalibrationBucket,
  type RoutingDomainMetrics,
  type RoutingSurfaceReport,
} from './routing-accuracy-snapshot-contract';
...
export type {
  ...
  RoutingAccuracySurface,
  RoutingCalibrationBucket,
  RoutingDomainMetrics,
...
const SNAPSHOT_MINIMUM_LABELED_ITEMS = ROUTING_ACCURACY_SNAPSHOT_MINIMUM_LABELED_ITEMS;
...
export function getLatestAcceptedAccuracySnapshot(
  ...
  if (!row) return null;
  return parseAcceptedRoutingAccuracySnapshot(row.snapshotJson);
}
