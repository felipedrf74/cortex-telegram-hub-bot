...
export const CHAT_BILINGUAL_EVAL_FIXTURES: ChatBilingualEvalFixture[] = [
  ...
  ...skill('cooking', 'recipe', [
    ['generic_recipe', 'Me indique uma receita de kibe de forno para 3 pessoas', 'Suggest an oven-baked kibbeh recipe for 3 people', 'generic_skill_answer', 'none'],
    ...
    ['cooking_timing', 'Quanto tempo assa kibe de forno?', 'How long does oven-baked kibbeh take?', 'generic_skill_answer', 'none'],
    ...
    ['portuguese_recipe_repair', 'Não, eu pedi receita de kibe', 'No, I asked for a kibbeh recipe', 'repair', 'local'],
  ]),
