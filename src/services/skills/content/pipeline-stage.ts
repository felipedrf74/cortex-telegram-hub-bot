...
export const CONTENT_PIPELINE_TRANSITION_STAGES = ['scripted', 'filming', 'editing', 'published'] as const;
...
const STAGE_PATTERN_BY_STAGE: Record<ContentPipelineTransitionStage, string> = {
  ...
  filming: 'filmed|filming|ready\\s+to\\s+film|filmado|filmada|gravado|gravada|filmagem|grabado|grabada',
