...
export const PLATFORM_FORMATS: Record<ContentFormatId, PlatformFormatDefinition> = {
  youtube_long_form: {
    ...
    lengthExpectation: '6-18 minutes or 900-2600 spoken words by default.',
    pacing: 'Pattern interrupts every 45-90 seconds; deeper evidence can breathe.',
  ...
  youtube_shorts: {
    ...
    lengthExpectation: '15-60 seconds, usually one clear idea.',
    pacing: 'Immediate hook, short lines, minimal setup.',
  ...
  instagram_reel: {
    ...
    lengthExpectation: '7-45 seconds with strong visual clarity.',
    pacing: 'Fast but warm; prioritize save/share value.',
  ...
  tiktok: {
    ...
    lengthExpectation: '10-60 seconds; one strong emotional or useful arc.',
    pacing: 'Native, direct, low-polish acceptable when intentional.',
  ...
  linkedin_post: {
    ...
    lengthExpectation: '80-350 words by default.',
    pacing: 'Readable line breaks, one idea per paragraph.',
  ...
  x_thread: {
    ...
    lengthExpectation: '4-12 posts unless a tenant format override says otherwise.',
    pacing: 'Each post must carry a standalone reason to continue.',
  ...
  newsletter: {
    ...
    lengthExpectation: '500-1600 words depending on cadence.',
    pacing: 'Editorial, skimmable, with clear section promises.',
  ...
  blog: {
    ...
    lengthExpectation: '900-2400 words by default.',
    pacing: 'Searchable, structured, evidence-forward.',
  ...
  podcast_outline: {
    ...
    lengthExpectation: '20-90 minute outline with flexible segment timing.',
    pacing: 'Conversational arcs with room for exploration.',
  ...
  carousel: {
    ...
    lengthExpectation: '5-12 slides by default.',
    pacing: 'One idea per slide; visual hierarchy matters.',
  ...
  caption: {
    ...
    lengthExpectation: 'Platform-dependent; should match the linked output.',
    pacing: 'Concise and action-oriented.',
