-- Migration 137: Nexus Points settlement hardening.
--
-- Migration 136 supersedes the original 069/075 Pro/Max caps. This follow-up
-- keeps 136 immutable while making overage settlement idempotent per api_usage
