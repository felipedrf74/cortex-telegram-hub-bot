...
describe('Chat Core v2 command bus gate', () => {
  ...
  it('rejects dismiss-typed chat-origin commands that claim the system automation surface', () => {
    const envelope = command({
      commandId: 'cmd_chat_origin_decision_dismiss',
      commandSchemaVersion: 'decision_center.dismiss@1.0.0',
      previewSchemaVersion: 'decision_preview_card@1.0.0',
      domain: 'decision_center',
      commandType: 'decision_center.dismiss',
      origin: 'chat',
      payload: { operation: 'dismiss', decisionId: 'dc_1' },
      basedOn: {
        entityIds: ['decision:dc_1'],
        entityVersions: { 'decision:dc_1': 'decision_v1' },
        contextHash: 'ctx_decision_1',
      ...
      idempotencyKey: 'chat:tenant_1:user_1:decision_center.dismiss:dc_1:cmd_chat_origin_decision_dismiss',
    });
