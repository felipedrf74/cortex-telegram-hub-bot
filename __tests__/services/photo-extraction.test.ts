...
describe('photo extraction service', () => {
  ...
  it('normalizes supported app image attachments', () => {
    ...
    expect(normalizePhotoExtractionAttachment({ base64: 'not-base64!!!', mimeType: 'image/png' })).toBeNull();
  ...
  it('rejects oversized image payloads before classifier invocation', () => {
