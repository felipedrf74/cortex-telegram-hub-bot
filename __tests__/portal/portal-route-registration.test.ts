...
const API_ONLY_ROUTES: Record<string, string> = {
  ...
  'GET /api/chat/diagnostics': 'Chat diagnostics card (portal phase 4)',
  ...
  'GET /api/webhooks/stats': 'Webhooks card (portal phase 4)',
  'GET /api/webhooks/subscriptions': 'Webhooks card (portal phase 4)',
  'POST /api/webhooks/subscriptions': 'Webhooks card (portal phase 4)',
  'DELETE /api/webhooks/subscriptions/:id': 'Webhooks card (portal phase 4)',
  'GET /api/webhooks/events': 'Webhooks card (portal phase 4)',
  'POST /api/webhooks/events/:id/replay': 'Webhooks card (portal phase 4)',
