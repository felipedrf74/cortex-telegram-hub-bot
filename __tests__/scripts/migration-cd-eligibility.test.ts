...
describe('migration inventory', () => {
  it('covers every migration file, ordered, with byte digests', () => {
    ...
    expect(inventory.slice(-10)).toMatchObject([
      ...
      {
        file: '312_content_neutral_legacy_defaults.sql',
        kind: 'backfill',
        predecessorCompatible: true,
      },
      {
        file: '313_runtime_logs.sql',
        kind: 'expand',
        predecessorCompatible: true,
      },
      {
        file: '314_http_request_log.sql',
        kind: 'expand',
        predecessorCompatible: true,
      },
      {
